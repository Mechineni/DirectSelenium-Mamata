 ...
 */
public class OrdersDocumentSearchPage {

    static private ObjectRepository obje = new ObjectRepository();
    static private WebDriver driver;
    //Page Elements
    static private By DocumentSearchHeading = By.xpath("//td[@class='ListHeaderNew'][contains(text(),'DOCUMENT SEARCH')]");


    public static boolean VerifyOrdersDocumentSearchPageAssert(WebDriver driver) throws InterruptedException, IOException, WriteException {
        boolean Status=false;
        ExpectedLable("Verify that Document Search Page is opened or not ?");
        if(SizeOfTheElement(driver,DocumentSearchHeading)>0) {
